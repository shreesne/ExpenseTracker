...
namespace ExpenseTracker.Controllers
{
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TransId,CategoryId,Amount,Note,Date")] Transaction transaction)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransId,CategoryId,Amount,Note,Date")] Transaction transaction)
        {
        ...
        {
          return (_context.Transaction?.Any(e => e.TransId == id)).GetValueOrDefault();
        }
    }
}
